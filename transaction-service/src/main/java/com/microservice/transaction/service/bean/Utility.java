...
public class Utility {
	...
	/**
	 * @author This method is used to convert java.util.date to java.sql.date
	 */
	...
	/**
	 * @author This method is used to convert stringDate to java.sql.date
	 */
	...
	/**
	 * @author This method is used to convert StringDate into java.util.date in
	 *         yyyy-mm-dd format
	 */
	...
	/**
	 * @author This method is used to get the difference between two String days by
	...
	/**
	 * @author This method is used to add day with given strDate
	 */
